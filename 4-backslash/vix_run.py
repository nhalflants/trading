...
import os
from strategies.vix_strategy import VIXStrategy
...
csv_file = os.path.dirname(os.path.realpath(__file__)) + "/data/spy_vix.csv"
vix_csv_file = os.path.dirname(os.path.realpath(__file__)) + "/data/vix.csv"
